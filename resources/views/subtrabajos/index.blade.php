...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="page-title">
            <i class="bi bi-diagram-3-fill title-icon"></i> Subtrabajos
        </h4>
    </div>

    {{-- Filtros --}}
    <form action="{{ route('subtrabajos.index') }}" method="GET" class="mb-3">
        <div class="row g-2 align-items-end">
            ...
            <div class="col-md-2 d-flex gap-2 align-self-end">
                ...
                <a href="{{ route('subtrabajos.index') }}" class="btn btn-outline-secondary btn-sm w-100" title="Limpiar">
        ...
        <table class="table mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="small">
                        @if($sub->responsable)
                            {{ $sub->responsable->nombre_completo }}
                        @else
